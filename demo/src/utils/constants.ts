...
<div style="margin: 40px; padding: 15px; background-color: #f9f9f9;">
  <h1 style="text-align: right; color: crimson; margin-bottom: 0;">
    Advanced Test Document
  </h1>

  <p style="font-size: 18px; line-height: 1.6; text-indent: 30px;">
    This paragraph tests 
    <span style="letter-spacing: 2px;">letter-spacing</span>, 
    <span style="word-spacing: 8px;">word-spacing</span>, and 
    <small>small text</small> effects.
  </p>

  <p style="text-align: justify; margin: 20px;">
    Here is a 
    <span style="text-decoration: line-through underline;">
      combined decoration
    </span>
  ...
  <h2>Complex Table</h2>
  <table
    style="border-collapse: separate; border-spacing: 8px; width: 100%; margin-bottom: 20px;"
    border="2"
  >
    ...
    <colgroup>
      <col style="width: 30%; background-color: #e0f7fa;" />
      <col style="width: 35%;" />
      <col style="width: 35%;" />
    </colgroup>
    <thead>
  ...
  <img
    src="https://images.pexels.com/photos/31579434/pexels-photo-31579434/free-photo-of-scenic-rocky-beach-in-antalya-turkiye.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    alt="Floating image"
    style="float: left; margin: 15px; border: 2px dashed #333;"
  />
  <p>
    This text should wrap around the floating image to test inline float handling 
    in the converter. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
  </p>
